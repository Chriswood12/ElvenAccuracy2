...
const calculateSingleAttack = (attackNumber, useSharpShooter, hexed, hexCursed, adv, reaper) =>{
    ...
    if(reaper===1){
      ...
      necro += reap1+reap2;
      console.log(`Reaper added (${reap1}+${reap2}) necrotic`);
    }

    makeRollStats(attackNumber, toHit, necro, finalPierc, (reaper===1), (hexed===1), (hexCursed===1), (adv===1), (useSharpShooter===1));
